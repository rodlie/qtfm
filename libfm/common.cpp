...
QString Common::findIconInDir(QString appPath, QString theme, QString dir, QString icon)
{
    QString result;
...
QString Common::findIcon(QString appPath, QString theme, QString fileIcon)
{
    QString result;
...
QString Common::findApplication(QString appPath, QString desktopFile)
{
    QString result;
...
QString Common::findApplicationIcon(QString appPath, QString theme, QString app)
{
    QString result;
...
QStringList Common::videoFormats()
{
    QStringList formats;
